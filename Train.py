...
#parser.add_argument('-c','--classifier',type=str,nargs='?',default="/cygdrive/c/Users/chris/Documents/WatermelonCapstone/WatermelonClassifier/cascade.xml",help="Classifier for input images")
parser.add_argument('-i','--images',type=str,nargs='+',required=True,help="Images to train network with")
